...
import { LayoutDashboard, LogOut, PanelLeft, FileText, Upload, Settings, Package, Box, FileCheck, SearchCheck, BarChart3, Plus, Search, Bell, Palette, Mail } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Upload, label: "Import Cases", path: "/import" },
  { icon: Package, label: "Order Monitoring", path: "/orders" },
  { icon: Box, label: "Products", path: "/products" },
  { icon: FileCheck, label: "Certifications", path: "/certifications" },
  { icon: SearchCheck, label: "Shipment Audits", path: "/audits" },
