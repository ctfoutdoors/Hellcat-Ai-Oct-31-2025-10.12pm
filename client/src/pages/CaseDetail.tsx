...
import { ArrowLeft, Mic, Upload, FileText, Activity, FileCheck, Loader2, Download, Edit, ExternalLink, Camera } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              onClick={async () => {
                try {
                  toast.info("Generating dispute letter PDF with appendices...");
